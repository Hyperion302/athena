...
export async function decacheUserReference(
  server: Guild,
...
export async function decacheChannelReference(
  server: Guild,
...
export async function decacheRoleReference(
  server: Guild,
  resourceList: ResourceList,
  ref: ResourceReference
): Promise<Role> {
...
export async function decacheUserOrRoleReference(
  server: Guild,
  resourceList: ResourceList,
  ref: ResourceReference
